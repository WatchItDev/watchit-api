...
import    { DateResolver,DateTimeResolver,JSONResolver,TimestampResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { getComment: Query_getComment,getComments: Query_getComments,getEdgeStatus: Query_getEdgeStatus,getPost: Query_getPost,getPosts: Query_getPosts,getUser: Query_getUser },
      Mutation: { createComment: Mutation_createComment,createPost: Mutation_createPost,createUser: Mutation_createUser,hidePost: Mutation_hidePost,sendHumanMessage: Mutation_sendHumanMessage,setEdgeStatus: Mutation_setEdgeStatus,updateComment: Mutation_updateComment,updatePost: Mutation_updatePost,updateUser: Mutation_updateUser },
