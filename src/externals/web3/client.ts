...
import type { WriteContractOptions, ReadContractOptions, HexAddress } from './types'
...
if (!API_RPC_URL || !API_PRIVATE_KEY) throw new Error('Missing API_RPC_URL or API_PRIVATE_KEY in env')
