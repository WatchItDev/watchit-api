...
import    { DateResolver,DateTimeResolver,JSONResolver,TimestampResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { getCommentsByPost: Query_getCommentsByPost,getCreatorTips: Query_getCreatorTips,getIsFollowing: Query_getIsFollowing,getIsLiked: Query_getIsLiked,getPost: Query_getPost,getPostViews: Query_getPostViews,getPosts: Query_getPosts,getProfileViews: Query_getProfileViews,getRepliesByComment: Query_getRepliesByComment,getTargetEvents: Query_getTargetEvents,getTipsByBakerForPost: Query_getTipsByBakerForPost,getTipsForPost: Query_getTipsForPost,getUser: Query_getUser,getUserEvents: Query_getUserEvents,getUserTipsHistory: Query_getUserTipsHistory },
      Mutation: { createComment: Mutation_createComment,createPost: Mutation_createPost,createTip: Mutation_createTip,createUser: Mutation_createUser,hideComment: Mutation_hideComment,hidePost: Mutation_hidePost,humanMessage: Mutation_humanMessage,logAnonymousEvent: Mutation_logAnonymousEvent,logEvent: Mutation_logEvent,toggleFollow: Mutation_toggleFollow,toggleLike: Mutation_toggleLike,updateComment: Mutation_updateComment,updatePost: Mutation_updatePost,updateUser: Mutation_updateUser },
