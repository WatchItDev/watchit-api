...
export const resolvers: Resolvers = {
  Query: {
    getAchievements: Query_getAchievements,
    getActiveUsers: Query_getActiveUsers,
    getAllPosts: Query_getAllPosts,
    getBookmarksByPost: Query_getBookmarksByPost,
    getBookmarksByUser: Query_getBookmarksByUser,
    getCommentsByPost: Query_getCommentsByPost,
    getCreatorTips: Query_getCreatorTips,
    getIsBookmarked: Query_getIsBookmarked,
    getIsFollowing: Query_getIsFollowing,
    getIsLiked: Query_getIsLiked,
    getLeaderboard: Query_getLeaderboard,
    getPerks: Query_getPerks,
    getPopularPosts: Query_getPopularPosts,
    getPopularUsers: Query_getPopularUsers,
    getPost: Query_getPost,
    getPostViews: Query_getPostViews,
    getPosts: Query_getPosts,
    getPostsByAuthor: Query_getPostsByAuthor,
    getProfileViews: Query_getProfileViews,
    getRanksCatalog: Query_getRanksCatalog,
    getRecentPosts: Query_getRecentPosts,
    getRecentUsers: Query_getRecentUsers,
    getRepliesByComment: Query_getRepliesByComment,
    ...
    getUnlockedPerks: Query_getUnlockedPerks,
    getUser: Query_getUser,
    getUserBookmarks: Query_getUserBookmarks,
    getUserEvents: Query_getUserEvents,
    getUserFollowers: Query_getUserFollowers,
    getUserFollowing: Query_getUserFollowing,
    getUserRanks: Query_getUserRanks,
    getUserTipsHistory: Query_getUserTipsHistory,
    getUserXPHistory: Query_getUserXPHistory,
    getUsers: Query_getUsers,
    hasPerk: Query_hasPerk,
  },
  Mutation: {
    claimPerk: Mutation_claimPerk,
    createComment: Mutation_createComment,
    createPerk: Mutation_createPerk,
    createPost: Mutation_createPost,
    createRank: Mutation_createRank,
    createTip: Mutation_createTip,
    createUser: Mutation_createUser,
    deletePerk: Mutation_deletePerk,
    deleteRank: Mutation_deleteRank,
    hideComment: Mutation_hideComment,
    hidePost: Mutation_hidePost,
    humanMessage: Mutation_humanMessage,
    incrementPostView: Mutation_incrementPostView,
    logAnonymousEvent: Mutation_logAnonymousEvent,
    logEvent: Mutation_logEvent,
    toggleBookmark: Mutation_toggleBookmark,
    toggleFollow: Mutation_toggleFollow,
    toggleLike: Mutation_toggleLike,
    updateComment: Mutation_updateComment,
    updatePerk: Mutation_updatePerk,
    updatePost: Mutation_updatePost,
    updateRank: Mutation_updateRank,
